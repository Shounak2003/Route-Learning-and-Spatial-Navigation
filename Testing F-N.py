...
mazetype='8 junction'
mazecolor='grey'
instruct='Welcome to Route Learning Experiment!!!'
x_cord=-11.63135
start_time=viz.tick()
lastsensor='Point 1'
y_cord=0
...
#scene1 = viz.addChild('Models/8 Arrow Grey maze.osgb', scene=viz.Scene1)


##Adding mazes to the scene_Testing 6jn (15 nos) 3 consequtive then exit 

scene37 = viz.addChild('Models/Test6_F_ maze 1 .osgb', scene=Scene37)
scene38 = viz.addChild('Models/Test6_F_ maze 2 .osgb', scene=Scene38)
scene39 = viz.addChild('Models/Test6_F_ maze 3 .osgb', scene=Scene39)
scene40 = viz.addChild('Models/Test6_F_ maze 4 .osgb', scene=Scene40)
scene41 = viz.addChild('Models/Test6_F_ maze 5 .osgb', scene=Scene41)

scene42 = viz.addChild('Models/Test6_N_ maze 1.osgb', scene=Scene42)
scene43 = viz.addChild('Models/Test6_N_ maze 2.osgb', scene=Scene43)
scene44 = viz.addChild('Models/Test6_N_ maze 3.osgb', scene=Scene44)
scene45 = viz.addChild('Models/Test6_N_ maze 4.osgb', scene=Scene45)
scene46 = viz.addChild('Models/Test6_N_ maze 5.osgb', scene=Scene46)

scene47 = viz.addChild('Models/Test6_N_ maze 4.osgb', scene=Scene47)
scene48 = viz.addChild('Models/Test6_N_ maze 4.osgb', scene=Scene48)
scene49 = viz.addChild('Models/Test6_N_ maze 5.osgb', scene=Scene49)
scene50 = viz.addChild('Models/Test6_N_ maze 1.osgb', scene=Scene50)
scene51 = viz.addChild('Models/Test6_N_ maze 5.osgb', scene=Scene51)

##Adding mazes to the scene_Testing 12jn (15 nos) 3 consequtive then exit 

scene52 = viz.addChild('Models/Test12_N_ maze 1.osgb', scene=Scene52)
scene53 = viz.addChild('Models/Test12_N_ maze 2.osgb', scene=Scene53)
scene54 = viz.addChild('Models/Test12_N_ maze 3.osgb', scene=Scene54)
scene55 = viz.addChild('Models/Test12_N_ maze 4.osgb', scene=Scene55)
scene56 = viz.addChild('Models/Test12_N_ maze 5.osgb', scene=Scene56)

scene57 = viz.addChild('Models/Test12_F_ maze 1 .osgb', scene=Scene57)
scene58 = viz.addChild('Models/Test12_F_ maze 2 .osgb', scene=Scene58)
scene59 = viz.addChild('Models/Test12_F_ maze 3 .osgb', scene=Scene59)
scene60 = viz.addChild('Models/Test12_F_ maze 4 .osgb', scene=Scene60)
scene61 = viz.addChild('Models/Test12_F_ maze 5 .osgb', scene=Scene61)

scene62 = viz.addChild('Models/Test12_F_ maze 5 .osgb', scene=Scene62)
scene63 = viz.addChild('Models/Test12_F_ maze 5 .osgb', scene=Scene63)
scene64 = viz.addChild('Models/Test12_F_ maze 5 .osgb', scene=Scene64)
scene65 = viz.addChild('Models/Test12_F_ maze 5 .osgb', scene=Scene65)
scene66 = viz.addChild('Models/Test12_F_ maze 5 .osgb', scene=Scene66)
        ...
        if check==1:
             ...
             if ((sensorname=='Point 4' and i>36 and i<=51) or (sensorname=='Point 2' and i>=52 and i<=66)     ) and conhit<=2 and i>36:
               ...
               # elif i==9 or i==13 or i==15 or i==19 or i==21 or i==24 or i==26 or i==29 or i==33 or i==35 or i==37 or i==39 or i==40 or i==42 or i==45 or i==47 or i==48 or i==50 or i==53 or i==54 or i==56 or i==57 or i==59 or i==61 or i==62 or i==64:
                 #   mazecolor='fear'
                if (i>=37 and i<=41) or (i>=57 and i<=66):
                    mazecolor='fear'
               ...
               # i=i+1
                ...
                if i==8 or i==10 or i==12 or i==14 or i==17 or i==23 or i==27 or i==31 or i==34 or i==36 or i<=6:
                    ...
                    mazecolor='red'
                elif i==9 or i==13 or i==15 or i==19 or i==21 or i==24 or i==26 or i==29 or i==33 or i==35  or i==39 or i==40 or i==42 or i==45 or i==47 or i==48 or i==50 or i==53 or i==54 or i==56 or i==57 or i==59 or i==61 or i==62 or i==64:
                    mazecolor='green'
                #else:
                 #   mazecolor='grey'
...
fileins = open('Responses/Testing/'+subject+' response in '+'.csv', 'w')
fileouts = open('Responses/Testing/'+subject+'response out '+'.csv', 'w')
