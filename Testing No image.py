...
scene37 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene37)
scene38 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene38)
scene39 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene39)
scene40 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene40)
scene41 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene41)

scene42 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene42)
scene43 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene43)
scene44 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene44)
scene45 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene45)
scene46 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene46)

scene47 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene47)
scene48 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene48)
scene49 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene49)
scene50 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene50)
scene51 = viz.addChild('Models/6NoArrow maze.osgb', scene=Scene51)

##Adding mazes to the scene_Testing 12jn (15 nos) 3 consequtive then exit 

scene52 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene52)
scene53 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene53)
scene54 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene54)
scene55 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene55)
scene56 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene56)

scene57 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene57)
scene58 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene58)
scene59 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene59)
scene60 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene60)
scene61 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene61)

scene62 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene62)
scene63 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene63)
scene64 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene64)
scene65 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene65)
scene66 = viz.addChild('Models/12NoArrow maze.osgb', scene=Scene66)
