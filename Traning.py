...
info = vizinfo.InfoPanel(instruct+'\n This study analyzes an individuals spatial route learning abilities using a virtual maze framework.\n The study contain 3 diffrent phases of a Traning, Learning and a Test phase. \n Now you will have 5 trials in the ' +phasenme+' Phase prior to the main study. \n  Your participation is voluntary, and you are free to leave the at any phase of the experiment.\n  Thank you for your participation.\n \n  Please press SPACE BAR to disable this instruction.', align=viz.ALIGN_RIGHT_TOP, icon=False)
