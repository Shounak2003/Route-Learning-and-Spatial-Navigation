...
scene7 = viz.addChild('Models/6_F_Arrow maze 1 .osgb', scene=Scene7)
scene8 = viz.addChild('Models/6_F_Arrow maze 2 .osgb', scene=Scene8)
scene9 = viz.addChild('Models/6_F_Arrow maze 4 .osgb', scene=Scene9)

scene10 = viz.addChild('Models/6_N_Arrow maze 4 .osgb', scene=Scene10)
scene11 = viz.addChild('Models/6_N_Arrow maze 5 .osgb', scene=Scene11)
scene12 = viz.addChild('Models/6_N_Arrow maze 1 .osgb', scene=Scene12)
scene13 = viz.addChild('Models/6_N_Arrow maze 2 .osgb', scene=Scene13)
scene14 = viz.addChild('Models/6_N_Arrow maze 3 .osgb', scene=Scene14)
scene15 = viz.addChild('Models/6_N_Arrow maze 4 .osgb', scene=Scene15)
scene16= viz.addChild('Models/6_N_Arrow maze 4 .osgb', scene=Scene16)
scene17 = viz.addChild('Models/6_N_Arrow maze 4 .osgb', scene=Scene17)
scene18 = viz.addChild('Models/6_N_Arrow maze 4 .osgb', scene=Scene18)
scene19 = viz.addChild('Models/6_N_Arrow maze 4 .osgb', scene=Scene19)
scene20 = viz.addChild('Models/6_N_Arrow maze 5 .osgb', scene=Scene20)
scene21 = viz.addChild('Models/6_N_Arrow maze 5 .osgb', scene=Scene21)

##Adding mazes to the scene_Learning  12jn (15 nos)with arrow

scene22 = viz.addChild('Models/12_F_Arrow maze 1 .osgb', scene=Scene22)
scene23 = viz.addChild('Models/12_F_Arrow maze 2 .osgb', scene=Scene23)
scene24 = viz.addChild('Models/12_F_Arrow maze 3 .osgb', scene=Scene24)

scene25 = viz.addChild('Models/12_N_Arrow maze 4 .osgb', scene=Scene25)
scene26 = viz.addChild('Models/12_N_Arrow maze 5 .osgb', scene=Scene26)
scene27 = viz.addChild('Models/12_N_Arrow maze 1 .osgb', scene=Scene27)
scene28 = viz.addChild('Models/12_N_Arrow maze 2 .osgb', scene=Scene28)
scene29 = viz.addChild('Models/12_N_Arrow maze 3 .osgb', scene=Scene29)
scene30 = viz.addChild('Models/12_N_Arrow maze 4 .osgb', scene=Scene30)
scene31 = viz.addChild('Models/12_N_Arrow maze 4 .osgb', scene=Scene31)
scene32 = viz.addChild('Models/12_N_Arrow maze 4 .osgb', scene=Scene32)
scene33 = viz.addChild('Models/12_N_Arrow maze 4 .osgb', scene=Scene33)
scene34 = viz.addChild('Models/12_N_Arrow maze 4 .osgb', scene=Scene34)
scene35 = viz.addChild('Models/12_N_Arrow maze 5 .osgb', scene=Scene35)
scene36 = viz.addChild('Models/12_N_Arrow maze 5 .osgb', scene=Scene36)
